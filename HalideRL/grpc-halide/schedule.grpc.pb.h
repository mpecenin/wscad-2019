...
class ScheduleService final {
 public:
  ...
  typedef WithAsyncMethod_init<WithAsyncMethod_step<WithAsyncMethod_reset<WithAsyncMethod_render<WithAsyncMethod_close<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_init<WithStreamedUnaryMethod_step<WithStreamedUnaryMethod_reset<WithStreamedUnaryMethod_render<WithStreamedUnaryMethod_close<Service > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_init<WithStreamedUnaryMethod_step<WithStreamedUnaryMethod_reset<WithStreamedUnaryMethod_render<WithStreamedUnaryMethod_close<Service > > > > > StreamedService;
};
