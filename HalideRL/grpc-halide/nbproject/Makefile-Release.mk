...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/grpc-halide: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/grpc-halide ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/schedule.grpc.pb.o: schedule.grpc.pb.cc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/schedule.grpc.pb.o schedule.grpc.pb.cc

${OBJECTDIR}/schedule.pb.o: schedule.pb.cc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/schedule.pb.o schedule.pb.cc
