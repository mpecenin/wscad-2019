...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/app-halide

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/app-halide: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/app-halide ${OBJECTFILES} ${LDLIBSOPTIONS} `libpng-config --ldflags` -lpthread -ldl -lrt -pthread
